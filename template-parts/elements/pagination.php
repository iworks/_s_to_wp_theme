<?php
/**
 * A template partial to output pagination for the THEME_NAME theme.
 *
 * @link https://developer.wordpress.org/themes/basics/template-files/#template-partials
 *
 * @package WordPress
 * @subpackage THEME_NAME
 * @since THEME_NAME 1.0.0
 */
...
$prev_text = sprintf(
	'<span class="nav-prev-text sr-only">%s</span>',
	__( 'View newer articles', 'THEME_SLUG' )
);
$next_text = sprintf(
	'<span class="nav-next-text sr-only">%s</span>',
	__( 'View older articles', 'THEME_SLUG' )
);
